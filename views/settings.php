...
<section class="card"><div class="section-heading"><h2><?=e($f?t('Feld bearbeiten','Edit field'):t('Feld hinzufügen','Add field'))?></h2><?php if($f)duplicate_button('field_definitions',$edit);?></div><?php start_form('field_save',['id'=>$edit]);?><div class="grid two">
