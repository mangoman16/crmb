 ...
 * web interface does, and a rule that can only be reached through one entry
 * point cannot be tested on its own.
 *
 * Each one either returns a value safe to store or throws UserError with a
